        ...
        <div class="flex flex-col md:flex-row flex-wrap justify-center">
          <div class="w-full md:basis-[30%] md:min-w-[250px] mb-5">
            <div class="logo">
              ...
              <h5 class="font-bold mt-2 border rounded-xl max-w-[200px] text-center">Designed by Eskanor</h5>
            </div>
          </div>
          <div class="w-full md:basis-[27%] md:min--[250px] mb-5">
           <div class="menu">
             ...
             <ul>
               ...
               <li class="mb-2 hover:font-bold transition-all duration-150 ease-in-out"><a href="" class="underline">About Us</a></li>
         ...
         <div class="w-full md:basis-[27%] md:min-w-[250px] mb-5">
           <div class="menu">
             ...
             <ul>
               ...
               <li class="mb-2 hover:font-bold transition-all duration-150 ease-in-out"><a href="" class=" text-lg">Linkedin <i class="fab fa-linkedin"></i></a></li>
             </ul>
           </div>
         </div>
       </div>
